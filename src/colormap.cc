...
crow red[] = { { 0.000, 0.00 }, { 0.125, 0.15 }, { 0.250, 0.30 },
               { 0.375, 0.60 }, { 0.500, 1.00 }, { 0.625, 0.90 },
               { 0.750, 0.90 }, { 0.875, 0.90 }, { 1.000, 1.00 } };

crow green[] = { { 0.000, 0.00 }, { 0.125, 0.15 }, { 0.250, 0.15 },
                 { 0.375, 0.20 }, { 0.500, 0.25 }, { 0.625, 0.50 },
                 { 0.750, 0.75 }, { 0.875, 0.90 }, { 1.000, 1.00 } };

crow blue[] = { { 0.000, 0.00 }, { 0.125, 0.50 }, { 0.250, 0.75 },
