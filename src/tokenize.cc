...
// quick and dirty std::string tokenizer. does not support quotes, escape characters etc...

void tokenize_string(const std::string& str, str_vec_t& tokens,
                     const std::string& delimiters, const bool keepEmpty)
{
    if (str.empty())
        return;
...
//    tokenize_string2() - based on zlib/libpng licensed (free) code by Jörg Wiedenmann

void tokenize_string2(const std::string& str, std::vector<std::string>& result,
                      const std::string& delimiters, const std::string& delimiters_preserve,
                      const std::string& quote, const std::string& esc, bool empty_tokens,
...
void tokenize_string2(const std::string& str, str_vec_t& result,
        bool empty_tokens, bool keep_quotes)
{
    tokenize_string2(str, result, " \t", "", "\"'", "\\", empty_tokens,
            keep_quotes);
}

std::vector<std::string> split(const std::string & input, const std::string & delim, bool keepEmpty)
{
